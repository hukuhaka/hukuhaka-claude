...
The script cats `.claude/backlog.md` (required), `.claude/map.md`, `.claude/design.md` (if present). If backlog.md is missing, the script exits 1 and you must STOP and tell the user to run `/project-mapper:map-init` first.

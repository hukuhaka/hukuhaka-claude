...
Create `.claude/` documentation scaffolding with 4 template files via bundled init script. No agents, no inline file writes. spec.md is managed separately by `/hukuhaka-project-mapper:map-spec generate`.
